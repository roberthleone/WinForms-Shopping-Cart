...
//Rob Leone
//COP 2010 - Project 3
//Create Point of SAle system for retail clothing store that add itesm to cart and calculates totals for transaction
//November 9th, 2017
...
namespace project3rleone
{
    public partial class Form1 : Form
    {
        ...
        private void AddToCartAndCalculations(double dblItemCost, string strString)
        {
            ...
            dblTaxAmount = dblSubtotal * dblTaxeRate;//updates the amount of taxes to be paid
